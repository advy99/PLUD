...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{"opciones/sonido.png"}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{"opciones/pantalla.png"}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{"opciones/controles_especifico.png"}
...
\begin{figure}[H]
    \centering
	 \begin{subfigure}[b]{0.49\textwidth}
		 ...
		 \caption{Error al intentar seleccionar una tecla ya asignada.}\label{fig:tecla_asignada_especifico}
	 \end{subfigure}
	 \begin{subfigure}[b]{0.49\textwidth}
		 \centering
		\includegraphics[width=\textwidth]{"opciones/tecla_invalida_especifico.png"}
		\caption{Error al intentar seleccionar una tecla inválida.}\label{fig:tecla_invalida_especifico}
   \end{subfigure}
